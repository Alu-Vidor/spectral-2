...
def main() -> None:
    ...
    print("Condition number (raw monomial system):", result.raw_condition_number)
    print("Condition number (QR-orthogonalized system):", result.condition_number)
    print("Condition number (left-preconditioned QR system):", result.preconditioned_condition_number)
    print("Residual norm:", result.residual_norm)
    print("Singular coefficient lambda:", result.coefficients[0])
    print("First five orthogonalized regular coefficients:", result.orthogonalized_coefficients[1:6])
